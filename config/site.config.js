...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'mary@coolert.onmicrosoft.com',
  ...
  protectedRoutes: ['/NSFW'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:keith920627@gmail.com',
